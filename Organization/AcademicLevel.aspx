<%@ page title="" language="C#" masterpagefile="~/MasterPages/DashboardMaster.master" autoeventwireup="true" inherits="Organization_AcademicLevel, App_Web_3j03txs0" %>
    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i><span class="font-weight-semibold">Home</span> - Academic Levels</h4>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">Academic Levels</span>
                </div>
                        ...
                        <asp:UpdatePanel ID="upTutorTypeCreation" UpdateMode="Conditional" runat="server">
                            <ContentTemplate>
                                <div class="panel panel-body">
                                    ...
                                    <asp:Button ID="BttnAddTutorType" CssClass="btn btn-success center-block" OnClientClick="return validateForm('txtMainMenu,txtSortOrder')" runat="server" Text="Academic Level" OnClick="BttnAddTutorType_Click" />
