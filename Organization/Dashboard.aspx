<%@ page title="" language="C#" masterpagefile="~/MasterPages/DashboardMaster.master" autoeventwireup="true" inherits="Organization_Dashboard, App_Web_3j03txs0" %>
            ...
            <div class="col-sm-6 col-xl-4">
                <div class="card card-body">
                    <div class="media">
                        ...
                        <div class="media-body text-right">
                            <h3 class="font-weight-semibold mb-0">382</h3>
    ...
    <!-- /content area -->
       ...
       <script>
           ...
           $('.confirm').click(function () {
               window.location.replace("../CommonPages/MyProfChanger.aspx");
           });
