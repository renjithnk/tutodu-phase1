<%@ page title="" language="C#" masterpagefile="~/MasterPages/DashboardMaster.master" autoeventwireup="true" inherits="Organization_ActiveCourses, App_Web_3j03txs0" %>
    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i><span class="font-weight-semibold">Home</span> - Active Courses</h4>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">Active Courses</span>
                </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <asp:TextBox runat="server" ID="TxtToDate" placeholder="" Text="" CssClass="form-control " />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label><b>&nbsp;</b></label>
                            <div class="input-group">
                               <asp:LinkButton ID="LnkBttnGetCourses" OnClick="LnkBttnGetCourses_Click" Text="Get Courses" class="btn btn-primary" runat="server" />
                            </div>
                        </div>
                    </div>
                </div>
