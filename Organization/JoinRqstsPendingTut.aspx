<%@ page title="" language="C#" masterpagefile="~/MasterPages/DashboardMaster.master" autoeventwireup="true" inherits="Organization_JoinRqstsPendingTut, App_Web_3j03txs0" %>
    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i><span class="font-weight-semibold">Academy Join Requests - Tutors</span> - Pending Requests</h4>
    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-header header-elements-inline">
                <h5 class="card-title">Tutors Pending Requests</h5>
            </div>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="text-center">
                                    <asp:LinkButton runat="server" ID="LinkButton4" CommandArgument='<%#Eval("Id")+","+ Eval("OrgRegNo")+","+ Eval("TutorId") %>' CommandName="Approve">ACCEPT</asp:LinkButton>&nbsp;&nbsp;/ 
                                            <asp:LinkButton runat="server" ID="LinkButton5" CommandArgument='<%#Eval("Id")+","+ Eval("OrgRegNo")+","+ Eval("TutorId") %>' CommandName="Reject">REJECT</asp:LinkButton>
                                </td>
