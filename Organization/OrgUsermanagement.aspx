<%@ page title="" language="C#" masterpagefile="~/MasterPages/DashboardMaster.master" autoeventwireup="true" inherits="Organization_OrgUsermanagement, App_Web_3j03txs0" %>
    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i><span class="font-weight-semibold">Organization</span> - Usermanagement</h4>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    <a href="../Tutor/Dashboard.aspx" class="breadcrumb-item"><i class="icon-home2 mr-2"></i>Organization</a>
                            ...
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gdvEmployeelist" CssClass="table table-bordered" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="TutorType" HeaderText="Designation" />
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                ...
                                                <%--'<%# Eval("UserID") %>'--%>
                                                <asp:HiddenField ID="hdnUserIDInGrid" Value='<%# Eval("LoginId") %>' runat="server"></asp:HiddenField>
