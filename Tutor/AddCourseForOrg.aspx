<%@ page title="" language="C#" masterpagefile="~/MasterPages/DashboardMaster.master" autoeventwireup="true" inherits="Tutor_AddCourseForOrg, App_Web_hacr2tjf" %>
    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i><span class="font-weight-semibold">Course</span> - Add Course</h4>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <fieldset>
                            <legend class="font-weight-semibold"><i class="icon-reading mr-2"></i>Organization Details</legend>
                        </fieldset>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <asp:DropDownList ID="DrpOrg" runat="server" OnSelectedIndexChanged="DrpOrg_SelectedIndexChanged" AutoPostBack="true" CssClass="form-control">
                                </asp:DropDownList>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label><b>Organization Course No.</b></label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="icon-envelop4"></i></span>
                                </div>
                                <asp:TextBox ID="TxtOrgCourseNo" runat="server" CssClass="form-control">
                                </asp:TextBox>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label><b>University Course No.</b></label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="icon-envelop4"></i></span>
                                </div>
                                <asp:TextBox ID="TxtUniCourseNo" runat="server" CssClass="form-control">
                                </asp:TextBox>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <asp:TextBox ID="TxtDuration" runat="server" Text="0" placeholder="" CssClass="form-control" />
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <asp:HiddenField ID="HddnFileUpFilename" runat="server" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <asp:TextBox runat="server" ID="TxtNoOfSeats" Text="0" placeholder="No of seats" CssClass="form-control" />
                                &nbsp;&nbsp;&nbsp;
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <asp:TextBox runat="server" Text="0.00" CssClass="form-control" ID="TxtFee" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-5">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <asp:Label Text="" ID="LblPriTutor" runat="server" CssClass="form-control" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <%--      <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <asp:CheckBoxList runat="server" ID="ChkbxTutors" RepeatDirection="Horizontal" CssClass="form-control checkbox">
                                </asp:CheckBoxList>
                            </div>
                        </div>
                    </div>--%>
                ...
                <div class="text-right">
                    <asp:Button ID="BttnSaveCourse" Text="Add Course" OnClick="BttnSaveCourse_Click" class="btn btn-primary" runat="server" />
                </div>
