<%@ page title="" language="C#" masterpagefile="~/MasterPages/DashboardMaster.master" autoeventwireup="true" inherits="Tutor_EditCourse, App_Web_hacr2tjf" %>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <asp:DropDownList ID="DrpCourseType" runat="server" CssClass="form-control">
                                    ...
                                    <asp:ListItem Text="Tuition" />
                                    <asp:ListItem Text="On Demand" />
                                </asp:DropDownList>
                            </div>
                        </div>
                    </div>
