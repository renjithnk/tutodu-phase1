<%@ page title="" language="C#" masterpagefile="~/MasterPages/AdminMasterPage.master" autoeventwireup="true" inherits="Tutor_TutorProfile, App_Web_hacr2tjf" stylesheettheme="SkinFile" theme="SkinFile" %>
    ...
    <div class="content">
      <asp:GridView ID="GrdVwRecords" runat="server" CssClass="table table-bordered" AllowPaging="True" PageSize="1" AutoGenerateColumns="False" OnRowDataBound="GrdVwRecords_RowDataBound">
        <Columns>
                    ...
                    <div class="card"">
                        <table class="table table-borderless profile-table">
                            <tbody>
                                <tr>
                                    <td class="PrfRow">
                                        <asp:Label ID="Lbl0" runat="server" Text="First Name" Width="100%"></asp:Label>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="PrfRow">
                                        <asp:Label ID="LblParentName" runat="server" SkinID="LblNormal" Text='<%#Eval("LastName")%>' />
                                    </td>
                                </tr>
                                 <tr>
                                ...
                                <tr>
                                    <td class="PrfRow">Resume</td>
                                    <td class="PrfClmnRow"><span>:</span></td>
                                    <td class="PrfRow">
                                        <asp:HyperLink ID="HyLnkResume" runat="server" Target="_blank" SkinID="HylnkGnl" />
                                    </td>
                                    <td></td>
                                </tr>
                                 <tr>
                                    <td class="PrfRow">Other Onformations</td>
                                    <td class="PrfClmnRow"><span>:</span></td>
                                    <td class="PrfRow">
                                        <asp:Label ID="Label5" runat="server" SkinID="LblNormal" Text='<%#Eval("OtherInformations")%>' />
                                    </td>
                                    <td></td>
                                </tr>
                            </tbody>
         ...
         <br />
                <div class="text-left">
                 <asp:Button ID="BttnEditProfile" Text="Edit Profile" SkinID="BtnCommandEdit" runat="server" />
                </div>
    </div>
</asp:Content>
