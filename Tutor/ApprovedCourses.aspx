<%@ page title="" language="C#" masterpagefile="~/MasterPages/DashboardMaster.master" autoeventwireup="true" inherits="Tutor_ApprovedCourses, App_Web_hacr2tjf" %>
    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i><span class="font-weight-semibold">Home</span> - Approved Courses</h4>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">Approved Courses</span>
                </div>
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <asp:LinkButton runat="server" ID="LinkButton1" CommandArgument='<%#Eval("Id")+","+Eval("Name")+","+Eval("AccId") %>' CommandName="View">VIEW</asp:LinkButton>
                                    </td>
                                 <%--   <td class="text-center">
