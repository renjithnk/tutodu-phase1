<%@ page title="" language="C#" masterpagefile="~/MasterPages/AdminMasterPage.master" autoeventwireup="true" inherits="Admin_RejectedTuror, App_Web_ybvgoxqu" stylesheettheme="SkinFile" theme="SkinFile" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-header header-elements-inline">
                <h5 class="card-title">Rejected Tutor</h5>
            </div>
                <div class="card-body">
                <div class="row">
                    <div class="col-md-.5">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Name" SortExpression="Name">
                                              ...
                                              <asp:TemplateField HeaderText="Address" SortExpression="PAddress">
                                                <ItemTemplate>
                                                    <asp:Label ID="LnkCategoryName" runat="server" Text='<%#Eval("PAddress")+" - "+Eval("CAddress") %>' Width="100px" SkinID="LblNormal"> </asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
    ...
    <!-- /content area -->
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="FnGetRejectedTutorList" TypeName="ClsDataBinding">
    <SelectParameters>
