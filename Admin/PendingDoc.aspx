<%@ page title="" language="C#" masterpagefile="~/MasterPages/AdminMasterPage.master" autoeventwireup="true" inherits="Admin_PendingDoc, App_Web_ybvgoxqu" stylesheettheme="SkinFile" theme="SkinFile" %>
...
<asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="FnGetPendingDocList" TypeName="ClsDataBinding">
    <SelectParameters>
