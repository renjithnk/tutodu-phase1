<%@ page title="" language="C#" masterpagefile="~/MasterPages/AdminMasterPage.master" autoeventwireup="true" inherits="Admin_AdminAddCourse, App_Web_ybvgoxqu" stylesheettheme="SkinFile" theme="SkinFile" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <script language="javascript" src="Script/AdminAddCourse.js" type="text/javascript"></script>
        <style>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <asp:DropDownList ID="DrpCourseType" runat="server" SkinID="DdlCourseType">
                                </asp:DropDownList>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                   <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <asp:DropDownList runat="server" ID="DrpPriTutor" SkinID="DdlList" >
                                </asp:DropDownList>
                            </div>
                        </div>
                    </div>
                 ...
                 <div class="row">
                      <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                          <asp:CheckBoxList runat="server" ID="ChkAddTutors" RepeatDirection="Horizontal" SkinID="ChkList">
                                </asp:CheckBoxList>
                                    </div>
                                </div>
                            </div>
