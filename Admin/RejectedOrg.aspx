<%@ page title="" language="C#" masterpagefile="~/MasterPages/AdminMasterPage.master" autoeventwireup="true" inherits="Admin_RejectedOrg, App_Web_ybvgoxqu" stylesheettheme="SkinFile" theme="SkinFile" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-header header-elements-inline">
                <h5 class="card-title">Rejected Organization</h5>
            </div>
                <div class="card-body">
                <div class="row">
                    <div class="col-md-.5">
    ...
    <!-- /content area -->
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="FnGetRejectedOrganiationRecordsList" TypeName="ClsDataBinding">
    <SelectParameters>
