<%@ page title="" language="C#" masterpagefile="~/MasterPages/DashboardMaster.master" autoeventwireup="true" inherits="Admin_RejectedOrg, App_Web_20na01yn" %>
    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i><span class="font-weight-semibold">Home</span> - Rejected Organizations</h4>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">Rejected Organizations</span>
                </div>
    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-header header-elements-inline">
                <h5 class="card-title">Rejected Organizations</h5>
            </div>
                                ...
                                <ItemTemplate>
                                    <tr>
                                      ...
                                      <%--  <td><%# Convert.ToInt32( Eval("IsApprove")) >= 0 ? "Enabled" : "Disabled" %></td>--%>
                                        ...
                                        <td class="text-center">
                                            <asp:LinkButton runat="server" ID="LinkButton5" CommandArgument='<%#Eval("Id") %>' CommandName="Approve">ENABLE</asp:LinkButton>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
