<%@ page title="" language="C#" masterpagefile="~/MasterPages/AdminMasterPage.master" autoeventwireup="true" inherits="Admin_OrgList, App_Web_20na01yn" stylesheettheme="SkinFile" theme="SkinFile" %>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="panel panel-body">
                                    <asp:GridView ID="GdvRecords" CssClass="table table-bordered" AllowPaging="True" AllowSorting="True" DataKeyNames="ID,Name,CompanyRegNo" PageSize="5" runat="server" 
                                        AutoGenerateColumns="False" DataSourceID="ObjectDataSource1" OnRowDataBound="GdvRecords_RowDataBound" OnSelectedIndexChanging="GdvRecords_SelectedIndexChanging">
                                         <Columns>
                                             ...
                                             <asp:TemplateField HeaderText="Email / Mobile No" SortExpression="Email">
                                              ...
                                              <asp:TemplateField HeaderText="Address" SortExpression="PAddress">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="LnkCity" runat="server" Text='<%#Eval("City") %>' Width="200px" SkinID="LblNormal"> </asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                             <asp:TemplateField HeaderText="Employee Id From Organization" >
                                                <ItemTemplate>
                                                    <asp:TextBox ID="TxtEmpOrgNo" runat="server" Text='' Width="200px" SkinID="TxtForCtrlSngl"> </asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                             <asp:TemplateField HeaderText="Join Now" >
                                                <ItemTemplate>
                                                    <asp:Button ID="BtnJoinNow" runat="server" Text='Join Now' Width="100px" OnClientClick="return confirm('Do you want to sent join request for this otrganizaruion');" CommandName="SELECT" SkinID="BtnGrdEdit"> </asp:Button>
                                                </ItemTemplate>
                                            </asp:TemplateField>
