<%@ page title="" language="C#" masterpagefile="~/MasterPages/AdminMasterPage.master" autoeventwireup="true" inherits="Admin_PendingStudent, App_Web_ybvgoxqu" stylesheettheme="SkinFile" theme="SkinFile" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!-- /content area -->
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="FnGetPendingStudentList" TypeName="ClsDataBinding">
    <SelectParameters>
