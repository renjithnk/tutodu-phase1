<%@ page title="" language="C#" masterpagefile="~/MasterPages/AdminMasterPage.master" autoeventwireup="true" inherits="Admin_ApprovedDoc, App_Web_ybvgoxqu" stylesheettheme="SkinFile" theme="SkinFile" %>
    ...
    <div class="content">
        <div class="card">
            <div class="card-header header-elements-inline">
                <h5 class="card-title">
                    <asp:Label ID="Label1" Text="Approved Courses" runat="server" /></h5>
            </div>
...
<asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="FnGetApprovedDocList" TypeName="ClsDataBinding">
    <SelectParameters>
