<%@ page title="" language="C#" masterpagefile="~/MasterPages/AdminMasterPage.master" autoeventwireup="true" inherits="Admin_RejectedDoc, App_Web_ybvgoxqu" stylesheettheme="SkinFile" theme="SkinFile" %>
    ...
    <div class="content">
        <div class="card">
            <div class="card-header header-elements-inline">
                <h5 class="card-title">
                    <asp:Label ID="Label1" Text="Rejected / Removed Courses" runat="server" /></h5>
            </div>
                                    ...
                                    <asp:GridView ID="GdvRecords" CssClass="table table-bordered" AllowPaging="True" AllowSorting="true" DataKeyNames="ID,Name" PageSize="5" runat="server" 
                                       ...
                                       <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Tutor" SortExpression="AccAName">
                                                <ItemTemplate>
                                                    <asp:Label ID="LblTutor" runat="server" Text='<%#Eval("AccName") %>' Width="100px" SkinID="LblNormal"> </asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Type" SortExpression="CourseTType">
                                             ...
                                             <asp:TemplateField HeaderText="Autor" SortExpression="AutorName">
                                                <ItemTemplate>
                                                    <asp:Label ID="LnkAutorName" runat="server"  NavigateUrl="#"  Text='<%#Eval("AutorName") %>' Width="100px"  SkinID="LblNormal"> </asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
...
<asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="FnGetRejectedDoceList" TypeName="ClsDataBinding">
    <SelectParameters>
        <asp:ControlParameter ControlID="TxtSearch" Name="PrmVal" PropertyName="Text" Type="String" />
        <asp:ControlParameter ControlID="HdnOrgCmpId" DefaultValue="0" Name="PrmOrgCmpId" PropertyName="Value" Type="Int32" />
    </SelectParameters>
    </asp:ObjectDataSource>
    <asp:HiddenField ID="HdnOrgCmpId" runat="server" Value="0" />
</asp:Content>
