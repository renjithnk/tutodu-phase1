<%@ page title="" language="C#" masterpagefile="~/MasterPages/AdminMasterPageOnly.master" autoeventwireup="true" inherits="Admin_TutorDetails, App_Web_ybvgoxqu" stylesheettheme="SkinFile" theme="SkinFile" %>
 ...
 <div  style="height:380px;overflow:scroll;">
    <asp:GridView ID="GrdVwRecords" runat="server" CssClass="table table-bordered" AllowPaging="True" PageSize="1" AutoGenerateColumns="False" OnRowDataBound="GrdVwRecords_RowDataBound">
        ...
        <table class="auto-style3">
            <tr>     
                <td><asp:Label ID="LblDepartment" runat="server" SkinID="LblBold" Width="80px" Text='Department'></asp:Label>
                <td><asp:DropDownList ID="DdlDepartment" runat="server" SkinID="DdlListRed"></asp:DropDownList></td>
                <td><asp:Label ID="LblTutorCat" runat="server" SkinID="LblBold" Width="80px" Text='Category' /></td>
                <td><asp:DropDownList ID="DdlTutorCat" runat="server" SkinID="DdlListRed"></asp:DropDownList></td>
                <td>
                <uc1:CtrlCommandAdv runat="server" ID="CtrlCommandAdv" IsVisibleEdit="false" />
                </td>
            </tr>
        </table>
</div>
