<%@ page title="" language="C#" masterpagefile="~/MasterPages/DashboardMaster.master" autoeventwireup="true" inherits="Admin_SwitchUserRqsts, App_Web_ybvgoxqu" %>
    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i><span class="font-weight-semibold">Home</span> - Switch To Tutor Requests</h4>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">Switch To Tutor Requests</span>
                </div>
    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-header header-elements-inline">
                <h5 class="card-title">Switch To Tutor Requests</h5>
            </div>
            <div class="card-body">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <asp:LinkButton runat="server" ID="LinkButton1" CommandArgument='<%#Eval("Id")+","+ Eval("StudentId") %>' CommandName="Accept">Accept</asp:LinkButton>
                                            / 
                                               <asp:LinkButton runat="server" ID="LinkButton5" CommandArgument='<%#Eval("Id")+","+ Eval("StudentId") %>' CommandName="Reject">Reject</asp:LinkButton> / 
                                             <asp:LinkButton runat="server" ID="LinkButton2" CommandArgument='<%#Eval("Id")+","+ Eval("StudentId") %>' CommandName="Delete">Delete</asp:LinkButton>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
