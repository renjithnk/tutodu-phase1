<%@ page language="C#" masterpagefile="~/MasterPages/AdminMasterPage.master" autoeventwireup="true" inherits="MenuSettings, App_Web_ybvgoxqu" title="Untitled Page" stylesheettheme="SkinFile" theme="SkinFile" %>
    ...
    <div class="content">
        <div class="card">
            <div class="card-header header-elements-inline">
                <h5 class="card-title">Group Wise Menu Settings</h5>
            </div>
