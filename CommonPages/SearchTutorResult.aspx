<%@ page title="" language="C#" masterpagefile="~/MasterPages/CommonMasterNew.master" autoeventwireup="true" stylesheettheme="SkinFile" inherits="CommonPages_SearchTutorResult, App_Web_wy5ggddp" %>
                                                        ...
                                                        <div class="card-body">
                                                            <nav>
                                                                <div class="nav nav-tabs" id="Div2" role="tablist">
                                                                    <div>
                                                                        <asp:CheckBoxList ID="ChkBxCountryMob" runat="server" CssClass="form-check-input checkboxmob" OnSelectedIndexChanged="ChkBxCountryMob_SelectedIndexChanged" AutoPostBack="true">
                                                                        </asp:CheckBoxList>
                                                                    </div>
                                                                </div>
                                                            </nav>
                                        ...
                                        <div class="search-single-tile d-flex align-items-end">
                                            ...
                                            <div class="search-info">
                                                  <h5><asp:Label ID="LblName" runat="server" ></asp:Label></h5>
                                                    <li><%#Eval("Nationality") + ","+ Eval("StateName")%></li>
                                                    <li><%#Eval("OtherInformations")%></li>
                                                <div>
                                        ...
                                        <div id="duration-toggledesk" class="collapse" aria-labelledby="duration-head" data-parent="#search-toggledesk" style="">
                                            <div class="card-body">
                                                <nav>
                                                    <div class="nav nav-tabs" id="Div2" role="tablist">
                                                        <div>
                                                            <asp:CheckBoxList ID="ChkBxCountry" runat="server" CssClass="form-check-input checkbox" OnSelectedIndexChanged="ChkBxCountry_SelectedIndexChanged" AutoPostBack="true">
                                                            </asp:CheckBoxList>
                                                        </div>
                                                    </div>
                                                </nav>
