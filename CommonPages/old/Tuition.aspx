<%@ page title="" language="C#" masterpagefile="~/MasterPages/CommonMasterNew.master" autoeventwireup="true" inherits="CommonPages_Tuition, App_Web_c3bvm4en" %>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="tuition-courses" role="tabpanel" aria-labelledby="tuition-courses-tab">
                                    ...
                                    <ItemTemplate>
                                        <div class="col-10 offset-1 offset-sm-0 col-sm-6 col-md-4 px-sm-2 mb-4">
                                            <div class="tuition-single d-flex align-items-end">
                                                ...
                                                <div class="tuition-info orangebox" style="height: 230px;">
                            ...
                            <div class="row">
                                <div class="col"></div>
                                <div class="col-md-3">
                                    <asp:LinkButton ID="LnkBttnViewAllCrss" OnClick="LnkBttnViewAllCrss_Click" class="view-btn" runat="server">View all Courses<i class="fa fa-long-arrow-right"></i></asp:LinkButton>
                                </div>
                                <div class="col"></div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="tuition-tutor" role="tabpanel" aria-labelledby="tuition-tutor-tab">
                                        ...
                                        <ItemTemplate>
                                            <div class="col-10 offset-1 offset-sm-0 col-sm-6 col-md-4 px-sm-4 mb-4">
                                                <div class="d-flex align-items-center justify-content-center">
                                                    <figure>
                                                        <img src='<%# FnGetCourseImagePath(Eval("ImageLivePath")) %>' style="width:90px;height:90px" />
                                                    </figure>
                                                    <figcaption>
                            ...
                            <div class="row">
                                <div class="col"></div>
                                <div class="col-md-3">
                                    <asp:LinkButton CssClass="view-btn" ID="LnkBttnViewAllTut" OnClick="LnkBttnViewAllTut_Click" runat="server">View all Tutors<i class="fa fa-long-arrow-right"></i></asp:LinkButton>
                                </div>
                                <div class="col"></div>
                            </div>
                        </div>
