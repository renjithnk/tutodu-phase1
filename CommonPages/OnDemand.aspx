<%@ page title="" language="C#" masterpagefile="~/MasterPages/CommonMasterNew.master" autoeventwireup="true" inherits="CommonPages_OnDemand, App_Web_wy5ggddp" %>
                                        ...
                                        <ItemTemplate>
                                            <div class="col-10 offset-1 offset-sm-0 col-sm-6 col-md-4 px-sm-4 mb-4">
                                                <div class="d-flex align-items-center justify-content-center">
                                                    <figure>
                                                        <img src='<%# FnGetCourseImagePath(Eval("ImageLivePath")) %>' style="cursor:pointer;" data-toggle="modal" data-target="#View-TutorModal" onclick="return FnTutorPage(<%#Eval("Id")%>,<%# Container.ItemIndex %>);" />
                                                    </figure>
                                                    <figcaption>
