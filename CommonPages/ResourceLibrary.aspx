<%@ page title="" language="C#" masterpagefile="~/MasterPages/CommonMasterNew.master" autoeventwireup="true" inherits="CommonPages_ResourceLibrary, App_Web_wy5ggddp" %>
    ...
    <section class="mb-5">
        <div class="container">
            ...
            <div class="rsearch-carousel">
                ...
                <asp:Repeater runat="server" ID="RptrPopularCourse" OnItemDataBound="RptrPopularCourse_ItemDataBound">
                    <ItemTemplate>
                        <div class="item">
                        <div class="tuition-single d-flex align-items-end">
                            <div class="tuition-info greenbox">
                                ...
                                <p><asp:Label ID="LblAutorName" runat="server" ></asp:Label></p>
                            ...
                            <div ><!--class="tuition-img" -->
                                <img src='<%# FnGetCourseImagePath(Eval("ImageLivePath")) %>' class="imgRadious">
                            </div>
                        </div>
                        </div>
                    </ItemTemplate>
