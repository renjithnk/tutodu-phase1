<%@ page title="" language="C#" masterpagefile="~/MasterPages/AdminMasterPageOnly.master" autoeventwireup="true" inherits="CommonAppPages_CoursePage, App_Web_2iozjjrd" stylesheettheme="SkinFile" theme="SkinFile" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <div  style="height:380px;overflow:scroll;">
    <asp:GridView ID="GrdVwRecords" runat="server" CssClass="table table-bordered" AllowPaging="True" PageSize="1" AutoGenerateColumns="False" OnRowDataBound="GrdVwRecords_RowDataBound">
                        ...
                        <table class="table table-borderless profile-table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="PrfClmnRow"><span>:</span></td>
                                    <td class="PrfRow">
                                        <asp:Label ID="LblEmail" runat="server" SkinID="LblNormal" Width="200px" Text='<%#Eval("CategoryName")%>' />
                                    </td>
                                </tr>
                                <tr>
        ...
        <uc1:CtrlCommandAdv runat="server" ID="CtrlCommandAdv" Visible="False" />
    </div>
</asp:Content>
