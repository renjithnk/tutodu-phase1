<%@ page title="" language="C#" masterpagefile="~/MasterPages/AdminMasterPageOnly.master" autoeventwireup="true" inherits="CommonAppPages_NotesPage, App_Web_yzly2g3e" stylesheettheme="SkinFile" theme="SkinFile" %>
                        ...
                        <div class="panel panel-body">
                            <div runat="server" style="overflow:scroll;height:100%;width:100%">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Note Title">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Note Type">
                                                <ItemTemplate>
                                                    <asp:Label ID="LblNotType" runat="server" Text='<%# Eval("NoteType") %>' SkinID="LblNormal" Width="100px"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
