<%@ page title="" language="C#" masterpagefile="~/MasterPages/AdminMasterPage.master" autoeventwireup="true" inherits="CMS_OnDemandPage, App_Web_gunrukzv" stylesheettheme="SkinFile" theme="SkinFile" %>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label><b>OnDeamnd Description</b></label>
                            <div class="input-group">
                                <asp:TextBox ID="TxtOnDemandDesc" runat="server" TextMode="MultiLine" SkinID="TxtForCtrlMul"  />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label><b>Tutor Description</b></label>
                            <div class="input-group">
                                <asp:TextBox ID="TxtTutorDesc" runat="server" TextMode="MultiLine" SkinID="TxtForCtrlMul"  />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">  
                     <div class="col-md-6">
                        <div class="form-group">
                            <label><b>Section 4 Tutor Description</b></label>
                            <div class="input-group">
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                            <label><b>Section 4 Tutor Image ( </b></label>
                 ...
                 <div class="row"> 
                     <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <asp:TextBox ID="TxtTestimonials" runat="server" TextMode="MultiLine" SkinID="TxtForCtrlMul"  />
                            </div>
                        </div>
                    </div>
                </div>
