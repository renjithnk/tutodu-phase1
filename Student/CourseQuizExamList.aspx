<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterNew.master" AutoEventWireup="true" CodeFile="CourseQuizExamList.aspx.cs" Inherits="Student_CourseQuizExamList" StylesheetTheme="SkinFile" %>
                                                    ...
                                                    <div id="DivDocAsgn" runat="server">
                                                     ...
                                                     <tr> 
                                                        ...
                                                        <td><asp:HiddenField ID="HdnExamId" runat="server" Value='<%#Eval("Id") %>' />
                                                            <asp:HiddenField ID="HdnResultId" runat="server" /><asp:HiddenField ID="HdnSubmitDate" runat="server" />
