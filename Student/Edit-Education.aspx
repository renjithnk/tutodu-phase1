<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterNew.master" AutoEventWireup="true" CodeFile="Edit-Education.aspx.cs" StylesheetTheme="SkinFile" Inherits="Student_Edit_Education" %>
                                        ...
                                        <div class="card-body">
                                            <asp:UpdatePanel ID="UpdtEduDet" UpdateMode="Conditional" runat="server">
                                                <ContentTemplate>
                                                    <table class="table table-borderless profile-table">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>:</td>
                                                                <td>
                                                                    <asp:DropDownList ID="DrpAcademicLevel" runat="server" SkinID="DdlList">
                                                                    </asp:DropDownList>
                                                                </td>
                                                                <td></td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>:</td>
                                                                <td>
                                                                    <asp:TextBox ID="TxtSchool" CssClass="form-control formtextbox" Text="" runat="server" /></td>
                                                                <td></td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>:</td>
                                                                <td>
                                                                    <asp:TextBox ID="TxtField" CssClass="form-control formtextbox" Text="" runat="server" /></td>
                                                                <td></td>
                                                            </tr>
                                                            <tr >
                                                                ...
                                                                <td ><asp:CheckBox ID="ChkbxEdu" CssClass="checkbox" Text="Pursuing" runat="server" /></td>
                                                                <td></td>
                                                            </tr>
                                                            <tr>
                                                                <td>End Date</td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>:</td>
                                                                <td>
                                                                    <asp:TextBox ID="TxtGrade" CssClass="form-control formtextbox" Text="" runat="server" /></td>
                                                                <td></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <asp:Label Text="" ID="LblErrMsgEduInf" runat="server" />
                                                        </div>
                                                    </div>
                                                    <br />
                                                    <div class="row mb-5">
                                                    ...
                                                    <div>
                                                        <asp:Repeater runat="server" ID="RptrEduDet" OnItemCommand="RptrEduDet_ItemCommand">
                                                            <ItemTemplate>
