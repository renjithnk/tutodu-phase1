<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterNew.master" AutoEventWireup="true" CodeFile="CourseTimeSheet.aspx.cs" Inherits="Student_CourseTimeSheet" StylesheetTheme="SkinFile" %>
                            ...
                            <div class="course-status-table mt-4">
                                <div class="course-status-row">
                                    <div class="course-status-title">
                                        <h3 class="section-heading">Course Instruction Time </h3>
                                    </div>
                                    <table class="table">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <asp:Repeater runat="server" ID="RptrTimeSheet">
                                                <ItemTemplate>
                                                    <tr>
                                                        <td>
