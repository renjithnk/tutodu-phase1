<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterNew.master" AutoEventWireup="true" CodeFile="CourseModuleDetails.aspx.cs" Inherits="Student_CourseModuleDetails"  StylesheetTheme="SkinFile" %>
                        ...
                        <div class="overview-right">
                            ...
                            <div class="course-status-table mt-4">
                                ...
                                <div class="course-status-row">
                                    ...
                                    <!--Module Documents-->
                                    <asp:Label ID="LblDocStyle" runat="server"></asp:Label>
                                    <!--Module Document End-->
                                     <!--Module-->
                                    ...
                                    <div class="module-btn-holder">
                                        <asp:Button ID="BtnMark" runat="server" class="gr-btn" Text="Mark as completed" OnClick="ManiPulateDataEvent_Clicked" ></asp:Button>
                                        <!--<a class="bl-btn" href="#">Next</a>-->
                                    </div>
                                    <!--Module-->
                                </div>
