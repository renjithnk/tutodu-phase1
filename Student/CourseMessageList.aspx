<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterNew.master" AutoEventWireup="true" CodeFile="CourseMessageList.aspx.cs" Inherits="Student_CourseMessageList"  StylesheetTheme="SkinFile" %>
                        ...
                        <div class="overview-right">
                            ...
                            <div class="course-status-table mt-4">
                                ...
                                <div class="course-status-row">
                                    ...
                                    <br />
                                    <br />
                                     <asp:Label ID="LblReply" runat="server" Text="Hai"></asp:Label>
                                    </div>
