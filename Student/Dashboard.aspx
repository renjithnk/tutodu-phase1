<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterNew.master" AutoEventWireup="true" CodeFile="Dashboard.aspx.cs" Inherits="Student_Dashboard" StylesheetTheme="SkinFile" %>
                    ...
                    <div class="profile-right">
                        ...
                        <div class="profile-intro">
                            <div class="d-md-flex align-items-center">
                                <h3 class="section-heading">Dash <span>Board</span></h3>
                            </div>
                            ...
                            <div class="course-status-table mt-4">
                                <div class="course-status-row">
                                    <div class="course-status-title">
                                        <h3 class="section-heading">Enrolled Courses</h3>
                                    </div>
                                    <div class="row">
                                    <asp:Repeater runat="server" ID="RptrEnrldCrss" OnItemDataBound="RptrEnrldCrss_ItemDataBound">
                                    <ItemTemplate>
                                    <div class="col-10 offset-1 offset-sm-0 col-lg-4 col-sm-6 mb-5 px-md-4">
                                    ...
                                    <div class="col-lg-3 order-last">
                                        <asp:HyperLink ID="HyLnkAllCourse" CssClass="view-btnNewSmall" runat="server">All Courses</asp:HyperLink>
                                    </div>
                                    </div>
                                </div>
                            </div>
                              <div class="course-status-table mt-4">
                                <div class="course-status-row">
                                    <div class="course-status-title">
                                        <h3 class="section-heading">Enrolled Organizations</h3>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="col"></div>
                                <div class="col-lg-3 order-last">
                                <asp:HyperLink ID="HyLnkAllOrg" CssClass="view-btnNewSmall" runat="server">All Organizations</asp:HyperLink>
                                </div>
                                </div>
                                </div>
                            </div>
