<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterNew.master" AutoEventWireup="true" CodeFile="CourseModules.aspx.cs" Inherits="Student_CourseModules"  StylesheetTheme="SkinFile" %>
                            ...
                            <div class="course-status-table mt-4">
                                <div class="course-status-row">
                                    <div class="course-status-title">
                                        <h3 class="section-heading">Course Modules </h3>
                                    </div>
                                    <div class="row">
                                        <asp:Repeater runat="server" ID="RptrCrsWeeks" OnItemDataBound="RptrCrsWeeks_ItemDataBound" >
                                            <ItemTemplate>
                                                <div class="col-md-4">
                                                    <asp:HyperLink ID="HyLnkView" runat="server">
                                                        <div class="course-module">
                                                            <h6><%#Eval("Name")%></h6>
                                                            <p>Status : <asp:Label id="LblVal" runat="server" Text="Success"></asp:Label><asp:Label id="LblVal1" runat="server" SkinID="LblRedCenter" Text="Success"></asp:Label></p>
                                                            <p>Duration : <span><%#Eval("Code")%></span></p>
                                                        </div>
                                                    </asp:HyperLink>
                                                    </a>
                                                </div>
