...
public partial class Student_Notifications : ClsPageEvents, IPageInterFace
{
    WebAppRegistration.WebAppRegitation objRegister = new WebAppRegistration.WebAppRegitation();
    WebAppNotification.WebAppNotification objNotification = new WebAppNotification.WebAppNotification();
