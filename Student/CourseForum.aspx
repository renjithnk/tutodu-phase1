<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterNew.master" AutoEventWireup="true" CodeFile="CourseForum.aspx.cs" Inherits="Student_CourseForum" StylesheetTheme="SkinFile" %>
                            ...
                            <div class="course-status-table mt-4">
                                <div class="course-status-row">
                                    <div class="course-status-title">
                                        <h3 class="section-heading">Course Forum </h3>
                                    </div>
                                    <!--Form area begins-->
                                    <div class="forum-form">
                                        <asp:TextBox id="TxtName" runat="server" placeholder="Enter your message..." SkinID="TxtForCtrlMul" TextMode="MultiLine"></asp:TextBox>
                                        <br />
