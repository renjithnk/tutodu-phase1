<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterNew.master" AutoEventWireup="true" CodeFile="MyCourses.aspx.cs" Inherits="Student_MyCourses" %>
                            ...
                            <div class="course-status-table mt-4">
                                <div class="course-status-row">
                                    <div class="course-status-title">
                                        <h3 class="section-heading">Course List </h3>
                                    </div>
                                      <div class="row">
                            ...
                            <div class="col-10 offset-1 offset-sm-0 col-lg-4 col-sm-6 mb-5 px-md-4">
                                <div class="popular-course-box" style="height: 325px">
                                    <div class="pp-course-img text-center mb-20">
                                        <img class="image-placeholder" width="300px" height="120px" src='<%# FnGetCourseImagePath(Eval("ImageLivePath")) %>' alt="icon">
                                    </div>
