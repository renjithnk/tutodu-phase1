<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterNew.master" AutoEventWireup="true" CodeFile="ClassTimeline.aspx.cs" Inherits="Student_ClassTimeline" %>
                ...
                <div class="col-md-4 col-lg-3">
                    ...
                    <div class="profile-left mt-5">
                        <div class="profile-img text-center">
                            <img src="../Assets/img/tutor.jpg" id="ImgProfile" runat="server" runat="server" width="150" height="150" />
                        </div>
