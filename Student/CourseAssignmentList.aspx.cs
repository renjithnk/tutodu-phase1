...
public partial class Student_CourseAssignmentList : ClsPageEvents, IPageInterFace
{
    ...
    protected override void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                HyLnkBackTop.NavigateUrl = FnRedirectBackPage("CourseAssignments.aspx", "", "&CRSEID=" + Request.QueryString["CRSEID"].ToString() + "&INDX=4");
                HyLnkBackBottom.NavigateUrl = FnRedirectBackPage("CourseAssignments.aspx", "", "&CRSEID=" + Request.QueryString["CRSEID"].ToString() + "&INDX=4");
