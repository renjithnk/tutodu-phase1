<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterNew.master" AutoEventWireup="true" CodeFile="CourseAnnouncements.aspx.cs" Inherits="Student_CourseAnnouncements" StylesheetTheme="SkinFile" %>
                            ...
                            <div class="course-status-table mt-4">
                                <div class="course-status-row">
                                    <div class="course-status-title">
                                        <h3 class="section-heading">Course Announcements </h3>
                                    </div>
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">Annoucement Details</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <asp:Repeater runat="server" ID="RptrAnnoucement">
                                                <ItemTemplate>
                                                    <tr>
                                                        <td>
