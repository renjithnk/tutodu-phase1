<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterNew.master" AutoEventWireup="true" CodeFile="CoursePractice.aspx.cs" Inherits="Student_CoursePractice" %>
                            ...
                            <div class="course-status-table mt-4">
                                <div class="course-status-row">
                                    <div class="course-status-title">
                                        <h3 class="section-heading">Practice Tests</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
