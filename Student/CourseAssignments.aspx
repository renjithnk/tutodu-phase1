<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterNew.master" AutoEventWireup="true" CodeFile="CourseAssignments.aspx.cs" Inherits="Student_CourseAssignments" StylesheetTheme="SkinFile" %>
                            ...
                            <div class="course-status-table mt-4">
                                <div class="course-status-row">
                                    <div class="course-status-title">
                                        <h3 class="section-heading">Course Assignments </h3>
                                    </div>
                                    <table class="table">
                                        <thead>
                                            <tr>
