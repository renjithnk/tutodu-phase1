<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterNew.master" AutoEventWireup="true" CodeFile="CourseGradeList.aspx.cs" Inherits="Student_CourseGradeList"  StylesheetTheme="SkinFile" %>
                            ...
                            <div class="course-status-table mt-4">
                                ...
                                <div class="course-status-row">
                                    <div class="course-status-title">
                                        <h3 class="section-heading" id="H4GradeTitle"  runat="server">Course Grade List</h3>
                                    </div>
                                     <table class="table">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <asp:Repeater runat="server" ID="RptrGradesList">
                                                <ItemTemplate>
                                                    <tr>
                                                        <td>
                                                        <asp:Label ID="lblRowNumber" Text='<%# Container.ItemIndex + 1 %>' runat="server" /></td>
                                                        <td><%#Eval("CourseExamQuestion") %></td>
                                                        <td><%#Eval("ActualMark") %></td>
                                                          <td><%#Eval("ObtainMark") %></td>
                                                          <td><%#Eval("ExamType") %></td>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:Repeater>
