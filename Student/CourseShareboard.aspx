<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterNew.master" AutoEventWireup="true" CodeFile="CourseShareboard.aspx.cs" Inherits="Student_CourseShareboard" %>
                            ...
                            <div class="course-status-table mt-4">
                                <div class="course-status-row">
                                    <div class="course-status-title">
                                        <h3 class="section-heading">Course Shareboard </h3>
                                    </div>
                                </div>
                            </div>
                        </div>
