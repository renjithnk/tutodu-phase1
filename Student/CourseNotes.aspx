<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterNew.master" AutoEventWireup="true" CodeFile="CourseNotes.aspx.cs" Inherits="Student_CourseNotes"  StylesheetTheme="SkinFile" %>
                        ...
                        <div class="overview-right">
                            ...
                            <div class="course-status-table mt-4">
                                <div class="course-status-row">
                                   ...
                                   <div id="EditorPanel">
                                       <h5>Note Title</h5>
                                       <asp:TextBox ID="TxtName" runat="server" SkinID="TxtForCtrlSngl" placeholder="Title"></asp:TextBox>
                                       <br />
                                    ...
                                    <br>
                                        ...
                                        <tbody>
                                            <asp:Repeater runat="server" ID="RptrNotes" OnItemDataBound="RptrNotes_ItemDataBound" OnItemCommand="RptrNotes_ItemCommand">
                                                <ItemTemplate>
                                                    <tr>
