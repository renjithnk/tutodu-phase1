<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterNew.master" AutoEventWireup="true" CodeFile="Notifications.aspx.cs" Inherits="Student_Notifications" %>
                    ...
                    <div class="profile-right">
                        ...
                        <div class="profile-intro">
                            <div class="d-md-flex align-items-center">
                                <h3 class="section-heading">My <span>Notifications</span></h3>
                            </div>
                            ...
                            <div class="course-status-table mt-4">
                                <div class="course-status-row">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <asp:Repeater runat="server" ID="RptrNotifications">
                                                <ItemTemplate>
                                                    <tr>
                                                        <td>
