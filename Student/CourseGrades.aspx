<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMasterNew.master" AutoEventWireup="true" CodeFile="CourseGrades.aspx.cs" Inherits="Student_CourseGrades" StylesheetTheme="SkinFile" %>
                            ...
                            <div class="course-status-table mt-4">
                                <div class="course-status-row">
                                    <div class="course-status-title">
                                        <h3 class="section-heading">Course Grades </h3>
                                    </div>
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">Actual Mark</th>
                                                <th scope="col">View</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <asp:Repeater runat="server" ID="RptrGrades" OnItemDataBound="RptrGrades_ItemDataBound">
                                                <ItemTemplate>
                                                    <tr>
                                                        <td>
                                                        <asp:Label ID="lblRowNumber" Text='<%# Container.ItemIndex + 1 %>' runat="server" /></td>
                                                        <td><%#Eval("CourseExamMasterName") %></td>
                                                        <td><%#Eval("CourseGrade") %></td>
                                                        <td><%#Eval("MaximumMark") %></td>
                                                        <td><%#Eval("ActualMark") %></td>
